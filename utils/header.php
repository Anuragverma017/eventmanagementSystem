    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>EVENCON</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a ir events , technical events , dance event , 
                wallpainting event , or many more ndoor all kind of college events <b>Evecon</b> team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
